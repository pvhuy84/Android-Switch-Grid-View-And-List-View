 ...
 */
public class ListNewsFragmentDisplayInGridView extends Fragment implements NewsRecyclerViewAdapter.NewsRecyclerViewAdapterOnClick, NewsRecyclerViewAdapter.NewsRecyclerViewAdapterItemDelete{
    private List<News> newsList;
    private NewsRecyclerViewAdapter newsRecyclerViewAdapter;
    private Context context;
    private RecyclerView rvListNews;

    public ListNewsFragmentDisplayInGridView() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newsRecyclerViewAdapter = new NewsRecyclerViewAdapter(context, newsList, ListNewsFragment.DISPLAY_BY_GRID_VIEW);
        ...
        rvListNews.setLayoutManager(new GridLayoutManager(context, 4));
